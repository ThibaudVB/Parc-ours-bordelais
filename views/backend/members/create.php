            ...
            <div class="col-md-12">
                <form action="<?php echo ROOT_URL . '/api/members/create.php' ?>" id="form-recaptcha" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <input id="pseudoMemb" name="pseudoMemb" class="form-control" type="text" minlength="6"
                    ...
                    <div class="form-group mt-2">
                        <button class="g-recaptcha btn btn-primary"
                            data-sitekey="6LcWhcwqAAAAAJW8DX1nqJ1W1B3LqN1nTNPAULrk" data-callback='onSubmit'
                            data-action='submit' type="submit" disabled> Créer un compte
                        </button>
                    </div>
                </form>
            </div>
